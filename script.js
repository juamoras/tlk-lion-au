...
function advanceMonth() {
  ...
  if (document.getElementById("pride").classList.contains("active")) {
    let pride = generatePride();
    displayPride(pride);
  }
}
...
function openTab(tabName) {
  ...
  if (tabName === "life") {
    ...
    generateEvent(); // Generate events when switching to the Explore or Pride tab
  }
}